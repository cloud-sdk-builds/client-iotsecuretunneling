...
[`@aws-sdk/client-iotsecuretunneling`](https://www.npmjs.com/package/@aws-sdk/client-iotsecuretunneling/v/3.341.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotsecuretunneling@3.341.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ATaVRIMampCOBAsv2O3R8m8toPP+4WicTZtUIHhfligDw0uT2++iEKhi4d1+FvMy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-iotsecuretunneling": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotsecuretunneling@3.341.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotsecuretunneling@3.341.0/index.min.mjs": "sha384-ATaVRIMampCOBAsv2O3R8m8toPP+4WicTZtUIHhfligDw0uT2++iEKhi4d1+FvMy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-iotsecuretunneling/blob/refs/tags/3.341.0/LICENSE
```
