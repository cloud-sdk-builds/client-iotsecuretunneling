...
[`@aws-sdk/client-iotsecuretunneling`](https://www.npmjs.com/package/@aws-sdk/client-iotsecuretunneling/v/3.1111.0).
...
- @aws-sdk/client-iotsecuretunneling v3.1111.0 - [https://cloud-sdk-builds.github.io/?sdk=client-iotsecuretunneling&version=3.1111.0](https://cloud-sdk-builds.github.io/?sdk=client-iotsecuretunneling&version=3.1111.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotsecuretunneling@3.1111.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-E6N4EKNfmoM4j7BSXQei+mV49xu8KDi3MamepRmhVOFkQ/Ka0/QF/2kaKoyp4LAN
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotsecuretunneling/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-iotsecuretunneling": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotsecuretunneling@3.1111.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iotsecuretunneling@3.1111.0/index.min.mjs": "sha384-E6N4EKNfmoM4j7BSXQei+mV49xu8KDi3MamepRmhVOFkQ/Ka0/QF/2kaKoyp4LAN"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-iotsecuretunneling";
...
```
https://github.com/cloud-sdk-builds/client-iotsecuretunneling/blob/refs/tags/3.1111.0/LICENSE
```
